        ...
        <aside className="space-y-5">
          <section className="form-card p-5">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              ...
              {event.allow_plus_one && <><div><p className="text-3xl font-bold text-[var(--brand)]">{event.plus_one_count}</p><p className="mt-1 text-xs text-[var(--muted)]">Plus one</p></div><div><p className="text-3xl font-bold text-[var(--brand)]">{event.estimated_guest_count}</p><p className="mt-1 text-xs text-[var(--muted)]">Estimated guests</p></div></>}
            </div>
