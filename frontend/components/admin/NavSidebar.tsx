...
const Ic = {
  ...
  rsvp:      <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>,
...
const NAV_GROUPS = [
  ...
  { label: 'WORKFLOWS', items: [
    { href: '/admin/rsvp', label: 'RSVP Workflows', icon: Ic.rsvp, minRole: 'event_manager' as const },
  ]},
  { label: 'ADMIN', items: [
    { href: '/admin/users',              label: 'Team',      icon: Ic.team,      minRole: 'super_admin' as const, tourId: 'nav-team' },
    { href: '/admin/developer/queue',    label: 'Queue monitor', icon: Ic.activity, minRole: 'super_admin' as const },
    { href: '/admin/settings/templates', label: 'Templates', icon: Ic.templates, minRole: 'event_manager' as const, tourId: 'nav-templates' },
